...
class SendMethodTwigExtension extends \Twig_Extension {
    ...
    */
    public function enviar_post_ws($method, $params, $formatear, $fechaCompleta, $filtro, $campos, $cantidad) {

        $servicio = new ServiciosController;
        $result = $servicio->enviarPeticionPost($method, $params, $formatear, $fechaCompleta, $filtro, $campos, $cantidad);
